...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({required this.articles});
  ...
  @override
  String toString() {
    return 'CategoryListState.loaded(articles: $articles)';
  }
...
abstract class _Loaded implements CategoryListState {
  const factory _Loaded({required final ArticleList articles}) = _$LoadedImpl;
